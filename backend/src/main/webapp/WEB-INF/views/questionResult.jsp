             ...
             <br>
	            <nav aria-label="Page navigation example">
				  ...
				  <ul class="pagination">
				    ...
				    <li class="page-item"><a class="page-link" href="${root}/main/search?search&sido=${houses.get(0).sidoName}&gugun=${houses.get(0).gugunName}&dong=${houses.get(0).dongName}&year=${houses.get(0).dealYear}&month=${houses.get(0).dealMonth}&page=3">2</a></li>
				    <li class="page-item"><a class="page-link" href="${root}/main/search?search&sido=${houses.get(0).sidoName}&gugun=${houses.get(0).gugunName}&dong=${houses.get(0).dongName}&year=${houses.get(0).dealYear}&month=${houses.get(0).dealMonth}&page=6">3</a></li>
				  </ul>
				</nav>
			</c:if>
          </div>
