...
import { createUser, checkId, deleteUser, updateUser, login, findById, tokenRegeneration, logout } from "@/api/member";
...
const memberStore = {
  ...
  mutations: {
    ...
    SET_IS_VALID_ID: (state, isValid) => {
      state.isValidId = isValid;
    }
  },
  actions: {
