...
export default {
  ...
  methods: {
    ...
    toDis(){
      this.$router.push({ name : "houseDetailDis"});
    },
    toInfo(){
      this.$router.push({ name : "houseDetailInfo"});
    },
    toEvent(){
      this.$router.push({ name : "houseDetailEvent"});
    },
    toHealth(){
      this.$router.push({ name : "houseDetailHealth"});
    },
  },
};
</script>
